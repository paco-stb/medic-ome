...
function renderHome() {
    ...
    btnIA.onclick = () => { const limit = checkGuestLimit(); if (!limit.allowed) { showAlert(`Mode invité limité !`, "error"); return; } if(audioCtx.state === 'suspended') audioCtx.resume(); state.useLLM = false; state.dailyTarget = null; renderDemographics(); };
